...
const ingreso_datos = require('readline-sync');///ingreso de datos asincrono
...
function detalle_tarea(lista) {
    ...
    let seleccion = ingreso_datos.question(`${kleur.blue('Selecciona la tarea que deseas ver')} si no ${kleur.blue('preciona 0')}\n`);
...
do {
    ...
    switch (ingreso) {
        ...
        case 3:
            ...
            ///ornenar lista en orden alfabetico
            if(lista.length>1){
                lista.sort((a,b)=>{
